                            ...
                            org.json.JSONArray().put(
                                JSONObject().put(
                                    ...
                                    buildString {
                                        ...
                                        appendLine("Genre rule: primary_genres must contain 1-2 most specific reliable album styles, such as Trap, Jazz Rap, Neo Soul, Art Pop, Synth-pop, House, or Ambient. Put broad parent genres in secondary_genres only when useful. Add microgenres only when evidence is strong.")
                                        appendLine("Korean rule: listening_guide must be Korean. If you cannot write it in Korean, return an empty string.")
                                        appendLine("Sample rule: samples_used must be short strings only, for example Aretha Franklin - Spirit in the Dark (contains sample). Do not return sample objects.")
