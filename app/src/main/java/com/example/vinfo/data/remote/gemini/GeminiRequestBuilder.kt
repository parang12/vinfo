                            ...
                            org.json.JSONArray().put(
                                JSONObject().put(
                                    ...
                                    buildString {
                                        ...
                                        appendLine("Genre rule: primary_genre must be the most specific reliable album style, such as Trap, Jazz Rap, Neo Soul, Art Pop, Synth-pop, House, or Ambient. Put the broad parent genre in secondary_genre only when useful.")
